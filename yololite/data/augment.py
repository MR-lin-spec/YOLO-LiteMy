...
class RandomPerspective:
    ...
    to images and their associated bounding boxes. It can be used as part of an
...
class CopyPaste(BaseMixTransform):
    ...
    This class implements the Copy-Paste augmentation technique as described in the paper  (https://arxiv.org/abs/2012.07177). It combines objects from
...
class Format:
    """
    A class for formatting image annotations for object detection tasks.
